...
<html>
<title>Quotation Unconfirmed</title>
...
<div class="w3-container">
    ...
    <div style="width: 100%; text-align: center;">
        <div class="w3-container">
            <strong style="font-size: 17px;color: #006FA4;">Reporte de cotizaciones sin confirmar</strong>
        </div>
        <p style="font-size: 12px;margin-top: 1em;">Cotizaciones sin confirmar desde <strong>{{$dateStart}}</strong> hasta el <strong>{{$dateEnd}}</strong></p>
    </div>
