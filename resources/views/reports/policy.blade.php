...
<div class="w3-container">
    ...
    <div style="width: 100%; text-align: center;">
        <div class="w3-container">
            <strong style="font-size: 17px;color: #006FA4;">Reporte de pólizas emitidas</strong>
        </div>
        <p style="font-size: 12px;margin-top: 1em;">Pólizas emitidas desde <strong>{{$dateStart}}</strong> hasta el <strong>{{$dateEnd}}</strong></p>
    </div>
