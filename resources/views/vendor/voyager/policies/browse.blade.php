...
@section('page_header')
    <div class="container-fluid">
        ...
        @endcan
        @can('quotation', app($dataType->model_name))
            <a href="{{ route('policies.create.policy') }}" class="btn btn-success btn-add-new">
                <i class="voyager-plus"></i> <span>Create Policy</span>
            </a>
        @endcan
